...
if __name__ =='__main__':
    ...
    trainWriter = HDF5DatasetWriter(dims=[1200 * 3,12,3,73],outputPath='./train-ori-balanced-STC.hdf5')
    valWriter = HDF5DatasetWriter(dims=[200 * 3,12,3,73],outputPath='./val-ori-balanced-STC.hdf5')
