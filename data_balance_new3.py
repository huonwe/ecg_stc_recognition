...
if __name__ =='__main__':
    ...
    trainWriter = HDF5DatasetWriter(dims=[3200-5 + 1200 * 3,12,3,73],outputPath='./train-new3-balanced.hdf5')
    valWriter = HDF5DatasetWriter(dims=[800 + 200 * 3,12,3,73],outputPath='./val-new3-balanced.hdf5')
    ...
    count1 = 0
    try:
        train_ecgs = h5py.File("./train-new3.hdf5", "r")
    ...
    try:
        ...
        count110 = 0
        count100 = 0
        val_ecgs = h5py.File("./val-new3.hdf5", "r")
        stop = False
        i = 0
        index = 0
